export function StatCard({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex flex-col rounded-xl bg-surface p-6 shadow-md dark:bg-surface-dark">
...
export function StoryCard({ title, by, excerpt }: { title: string; by: string; excerpt: string }) {
  return (
    <article className="flex flex-col gap-2 rounded-xl bg-surface p-6 shadow-md dark:bg-surface-dark">
...
export function ActionCard({ action, why }: { action: string; why: string }) {
  return (
    <div className="rounded-xl bg-surface p-6 shadow-md dark:bg-surface-dark">
